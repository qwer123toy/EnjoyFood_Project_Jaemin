const districts = {
    서울: ['전체', '관악구', '강남구', '강북구', '마포구', '서초구', '송파구', '영등포구', '동작구', '종로구', '중구', '용산구', '성동구', '광진구', '동대문구', '중랑구', '성북구', '강서구', '양천구', '구로구', '영등포구', '금천구', '관악구', '서초구'],
    부산: ['전체', '중구', '서구', '동구', '해운대구', '부산진구', '사하구', '연제구', '금정구', '강서구', '동래구', '영도구', '북구', '사하구', '기장군'],
    ...
    세종: ['전체'],
    경기: ['전체', '수원시', '성남시', '고양시', '용인시', '부천시', '안산시', '화성시', '남양주시', '전주시', '광명시', '시흥시', '의정부시', '하남시', '구리시', '안양시', '파주시', '김포시', '양주시', '이천시', '동두천시', '오산시', '여주시', '광주'],
