                ...
                <section id="categories">
                   ...
                   <!-- 기타 카테고리 항목 -->
					<label class="category" for="additional-category-checkbox">
					    <input type="checkbox" id="additional-category-checkbox" name="category" value="기타 카테고리"> 직접 입력
					</label>
					<input type="text" id="additional-category-input" name="additionalCategory" placeholder="직접 입력" style="display: none;">
