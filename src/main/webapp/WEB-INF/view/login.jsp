...
<body>
	...
	<main class="main">
		<h1>로그인</h1>
		<form id="loginForm">
			<label for="userID">아이디:</label> <input type="text" id="userID" name="userID" maxlength="20" required> 
			<label for="userPW">비밀번호:</label> <input type="password" id="userPW" name="userPW" maxlength="20" required>
			<p class="error hidden"></p>
			<button class="button" type="submit" id="login">로그인</button>
			<button class="button" type="button" id="signup">회원가입</button>
			<div class="helplinks">
				<a href="/findId" class="findlink">아이디 찾기</a> | 
				<a href="/findPw" class="findlink">비밀번호 찾기</a>
			</div>
		</form>
	</main>
</body>
