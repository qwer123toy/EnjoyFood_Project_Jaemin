	...
	<form method="post" id="ownerPage" action="/ownerPage">
		<div class="container">
			...
			<div class="info-section">
				...
				<input type="text" id="cafeName" name="cafeName" placeholder="상호명 입력"
					class="input-field" />
				...
				<div class="time-container">
					<div class="time-item">
						<label for="start-time">영업 시작 시간</label> <select id="start-time"
							name="start-time" class="input-field">
							<!-- 시간 옵션들 -->
					...
					<div class="time-item">
						<label for="end-time">영업 종료 시간</label> <select id="end-time"
							name="end-time" class="input-field">
							<option value="15:00">15:00</option>
							<option value="15:30">15:30</option>
							<option value="16:00">16:00</option>
							<option value="17:00">17:00</option>
			...
			<div class="imageUpload">
				...
				<img id="imagePreview" class="uploaded-image" name="menuInputpic"
					alt="이미지 미리보기" style="display: none;">
				<input type="file" id="cafePic" name="cafePic" accept="image/*"
					class="input-field">
				...
				<script>
					document.getElementById('cafePic').addEventListener(
							'change',
							function(event) {
							...
							.addEventListener(
									...
									function() {
										if (tagCount < 6) { // 최대 5개까지만 추가
											const newTagInput = document
													.createElement('input');
											newTagInput.type = 'text';
											tagCount++; // 태그 수 증가
											newTagInput.id = 'tagInput-'
													+ tagCount; // 문자열 연결 사용
											newTagInput.name = 'tagInput-'
													+ tagCount; // 문자열 연결 사용
											newTagInput.placeholder = '태그 입력';
											newTagInput.classList
													.add('input-field');
											document.getElementById(
													'tagContainer')
													.appendChild(newTagInput);
