...
<%-- 	<jsp:include page="/WEB-INF/module/sidebar.jsp"></jsp:include> --%>
	...
	<main class="main">
		...
		<form id="findPwForm">
			...
			<input type="password" class="hidden" id="userPW" name="userPW"
				maxlength="20">

			<label for="confirmPW" class="hidden">비밀번호 확인</label>
			<input type="password" class="hidden" id="confirmPW" name="confirmPW"
				maxlength="20">
